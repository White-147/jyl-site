...
export default function Skills() {
  return (
    <section id="skills" className="scroll-mt-16 bg-slate-50/85 py-10 sm:py-24 dark:bg-slate-900/85">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {group.items.map((item, j) => (
                    <span
                      ...
                      className="chip rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-sm text-slate-600 dark:border-slate-700 dark:bg-slate-900/85 dark:text-slate-300"
                    >
                      {item}
                    </span>
                  ))}
