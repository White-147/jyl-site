            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-lg bg-brand-700 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-brand-800 dark:bg-brand-600 dark:hover:bg-brand-500"
                >
              ...
              <p className="mx-auto mt-8 max-w-md space-y-1.5 text-xs leading-relaxed text-slate-400 dark:text-slate-500">
                <span className="block">
                  QQ 邮箱：
                  <a href={`mailto:${profile.emailQq}`} className="underline decoration-slate-300 underline-offset-2 hover:text-brand-600 dark:decoration-slate-600">
                    {profile.emailQq}
                  </a>
                </span>
                <span className="block">
                  Gmail（备用）：
                  <a href={`mailto:${profile.email}`} className="underline decoration-slate-300 underline-offset-2 hover:text-brand-600 dark:decoration-slate-600">
                    {profile.email}
                  </a>
                </span>
                <span className="block">
                  GitHub：
                  <a href={profile.github} target="_blank" rel="noreferrer" className="underline decoration-slate-300 underline-offset-2 hover:text-brand-600 dark:decoration-slate-600">
                    {profile.githubLabel}
                  </a>
                </span>
              </p>
