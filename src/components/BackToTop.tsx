...
export default function BackToTop() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-20 right-5 z-50 md:hidden flex h-12 w-12 items-center justify-center rounded-full bg-blue-700 text-white shadow-lg transition-all duration-300 hover:scale-110 hover:bg-blue-800 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-300 sm:h-14 sm:w-14 dark:bg-blue-600 dark:hover:bg-blue-500 dark:focus-visible:ring-blue-500/40 ${
